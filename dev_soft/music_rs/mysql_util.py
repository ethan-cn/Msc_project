...
def test_connect():
    ...
    conn = pymysql.connect(host='localhost', port=3396, database='music_rs', user='root', password='123456',
                           charset='utf8')
...
def read_top_users2mysql():
    """
        The friend recommendation results are read and written to the TopUsers table in the database
        :return:
        """
    # Opening a database Connection
    conn = pymysql.connect(host='localhost', port=3306, database='music_rs', user='root', password='root',
